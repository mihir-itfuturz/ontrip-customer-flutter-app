...
class CustomReadMoreTextState extends State<CustomReadMoreText> {
  ...
  Widget _builder(BuildContext context, bool isCollapsed, Widget? child) {
    ...
    Widget result = LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        TextSpan? preTextSpan, postTextSpan;
  ...
  TextSpan _buildAnnotatedTextSpan({required String data, required TextStyle textStyle, required RegExp? regExp, required List<Annotation>? annotations}) {
  ...
  _TextSpanTrimResult _trimTextSpan({required TextSpan textSpan, required int spanStartIndex, required int endIndex, required bool splitByRunes}) {
