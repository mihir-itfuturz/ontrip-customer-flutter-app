...
class _CustomBottomNavBarState extends State<CustomBottomNavBar> with TickerProviderStateMixin {
  ...
  final List<NavItem> _navItems = [
    ...
    NavItem(
      iconAsset: Graphics.instance.iconQrScanner,
      activeIconAsset: Graphics.instance.iconQrScanner,
      label: 'Scan',
      activeColor: Constant.instance.primary,
      iconType: NavIconType.scanButton,
    ),
    NavItem(
      iconAsset: Graphics.instance.iconCard,
      activeIconAsset: Graphics.instance.iconCardFill,
      label: 'Cards',
      activeColor: Constant.instance.primary,
      iconType: NavIconType.icon,
    ),
